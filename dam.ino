...
const char* ssid = "11 R"; // Enter your WIFI SSID
const char* password = "555@555@"; // Enter your WIFI Password

// Telegram credentials
#define BOTtoken "7221417799:AAGgUr9Vt2RBwR20tGBp8AXQDlk8CE6lW5Y" // Enter the bot token you got from botfather
#define CHAT_ID "5169637568" // Enter your chat ID you got from chatid bot
...
float thresholdValue1 = 60.0; // Threshold for opening gate 1
float thresholdValue2 = 50.0; // Threshold for opening both gates
